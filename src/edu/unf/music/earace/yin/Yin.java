...
/**
 * @author Joren Six An implementation of the YIN pitch tracking algorithm. See
 * <a
 * href="http://recherche.ircam.fr/equipes/pcm/cheveign/ps/2002_JASA_YIN_proof.pdf">the
 * YIN paper.</a>
 *
...
public class Yin
{
     ...
     *
     * @param fileName the file to annotate.
     * @param detectedPitchHandler handles the pitch information.
     * @throws UnsupportedAudioFileException Currently only WAVE files with one
     * channel (MONO) are supported.
     ...
     *
     * @param afis The audio stream.
     * @param detectedPitchHandler Handles the pitch information. If null then
     * the annotated pitch information is printed to
     * <code>System.out</code>
     * @throws UnsupportedAudioFileException Currently only WAVE streams with
     * one channel (MONO) are supported.
